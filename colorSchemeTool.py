...
class DerivedAttributeValue:
    ...
    @property
    def inherited(self):
        return self.parent.id != "TEXT" and isinstance(
            self.parent.value, AttributeValue
        )
...
def load_default_attributes(scheme_path):
    ...
    for attr in attributes:
        ...
        for option in options:
            ...
            if not option_value:
                continue
            if option_name == "FOREGROUND":
                attr_value.default_fore = option_value
            if option_name == "BACKGROUND":
                attr_value.default_back = option_value
            if option_name == "FONT_TYPE":
                attr_value.default_font = int(option_value)
            if option_name == "ERROR_STRIPE_COLOR":
                attr_value.error_stripe = option_value
            if option_name == "EFFECT_TYPE":
...
unmatched_brace = Attribute(
    "UNMATCHED_BRACE_ATTRIBUTES", text, background=(255, 220, 220)
)
...
default_doc_comment = Attribute(
    "DEFAULT_DOC_COMMENT", text, scope="comment.documentation"
)
default_operation_sign = Attribute(
    "DEFAULT_OPERATION_SIGN", text, scope="keyword.operator"
)
...
default_local_variable = Attribute(
    "DEFAULT_LOCAL_VARIABLE", default_identifier, scope="variable"
)
default_global_variable = Attribute(
    "DEFAULT_GLOBAL_VARIABLE", default_local_variable, font_style=2
)
default_function_declaration = Attribute(
    "DEFAULT_FUNCTION_DECLARATION", default_identifier, scope="entity.name.function"
)
default_function_call = Attribute(
    "DEFAULT_FUNCTION_CALL", default_identifier, scope="support.function"
)
default_parameter = Attribute(
    "DEFAULT_PARAMETER", default_identifier, scope="variable.parameter"
)
default_class_name = Attribute(
    "DEFAULT_CLASS_NAME", default_identifier, scope="entity.name"
)
default_interface_name = Attribute("DEFAULT_INTERFACE_NAME", default_class_name)
default_instance_method = Attribute(
...
default_valid_string_escape = Attribute(
    "DEFAULT_VALID_STRING_ESCAPE", text, scope="constant.character.escape"
)
default_invalid_string_escape = Attribute(
    "DEFAULT_INVALID_STRING_ESCAPE", text, scope="invalid"
)
default_predefined_symbol = Attribute(
    "DEFAULT_PREDEFINED_SYMBOL", default_identifier, scope="support.type"
)
...
default_markup_attribute = Attribute(
    "DEFAULT_ATTRIBUTE", default_identifier, scope="entity.other.attribute-name"
)
default_markup_entity = Attribute(
    "DEFAULT_ENTITY", default_identifier, scope="constant.character.entity"
)
default_template_language = Attribute(
    "DEFAULT_TEMPLATE_LANGUAGE_COLOR", text, scope="text source"
)

# CodeInsightColors (Java)
java_local_variable = Attribute("LOCAL_VARIABLE_ATTRIBUTES", text)
java_implicit_anonymous_class_parameter = Attribute(
    "IMPLICIT_ANONYMOUS_CLASS_PARAMETER_ATTRIBUTES", text
)
...
java_block_comment = Attribute(
    "JAVA_BLOCK_COMMENT", java_line_comment, scope="comment.block"
)
java_doc_comment = Attribute(
    "JAVA_DOC_COMMENT", java_line_comment, scope="comment.documentation"
)
...
java_valid_string_escape = Attribute(
    "JAVA_VALID_STRING_ESCAPE", text, scope="constant.character.escape"
)
java_invalid_string_escape = Attribute(
    "JAVA_INVALID_STRING_ESCAPE", text, scope="invalid"
)
...
xml_tag = Attribute(
    "XML_TAG", text, scope="punctuation.definition.tag", background=IGNORE_COLOR
)
xml_attribute_name = Attribute(
    "XML_ATTRIBUTE_NAME", text, scope="entity.other.attribute-name.localname.xml"
)
xml_tag_name = Attribute("XML_TAG_NAME", text, scope="entity.name.tag.xml")
xml_attribute_value = Attribute(
    "XML_ATTRIBUTE_VALUE", text, scope="string.quoted.double"
)
xml_tag_data = Attribute("XML_TAG_DATA", text)
xml_entity_reference = Attribute(
    "XML_ENTITY_REFERENCE", text, scope="constant.character.entity"
)

html_comment = Attribute(
    "HTML_COMMENT", default_block_comment, scope="comment.block.html"
)
html_tag = Attribute(
    "HTML_TAG", xml_tag, scope="punctuation.definition.tag", background=IGNORE_COLOR
)
html_tag_name = Attribute("HTML_TAG_NAME", xml_tag_name, scope="entity.name.tag")
html_attribute_name = Attribute(
    "HTML_ATTRIBUTE_NAME", xml_attribute_name, scope="entity.other.attribute-name.html"
)
...
py_valid_string_escape = Attribute(
    "PY.VALID_STRING_ESCAPE", default_valid_string_escape
)
py_invalid_string_escape = Attribute(
    "PY.INVALID_STRING_ESCAPE", default_invalid_string_escape
)
...
# CSS
css_ident = Attribute(
    "CSS.IDENT", html_tag_name, scope="entity.other.attribute-name.class.css"
)
css_comment = Attribute("CSS.COMMENT", html_comment, scope="comment.block.css")
css_property_name = Attribute(
    "CSS.PROPERTY_NAME", html_attribute_name, scope="support.type.property-name"
)
css_property_value = Attribute(
    "CSS.PROPERTY_VALUE", html_attribute_value, scope="meta.property-value.css"
)
...
css_function = Attribute(
    "CSS.FUNCTION", html_tag_name, scope="support.function.misc.css"
)
css_url = Attribute(
    "CSS.URL", html_attribute_value, scope="variable.parameter.misc.css"
)

# LESS
less_variable = Attribute("LESS_VARIABLE", text, scope="variable.other.less")
less_code_injection_delim = Attribute(
    "LESS_JS_CODE_DELIM", text, scope="source.css.less"
)
less_code_injection = Attribute(
    "LESS_INJECTED_CODE", text, scope="source.js.embedded.less", foreground=IGNORE_COLOR
)

# SASS
sass_identifier = Attribute(
    "SASS_IDENTIFIER", css_ident, scope="entity.other.attribute-name.class.css"
)
...
sass_extend = Attribute(
    "SASS_EXTEND", default_keyword, scope="keyword.control.at-rule.css"
)
sass_keyword = Attribute(
    "SASS_KEYWORD", default_keyword, scope="keyword.control.at-rule.css"
)
sass_important = Attribute(
    "SASS_IMPORTANT", default_keyword, scope="keyword.control.at-rule.css"
)
sass_default = Attribute(
    "SASS_DEFAULT", default_keyword, scope="keyword.control.at-rule.css"
)
sass_property_name = Attribute(
    "SASS_PROPERTY_NAME", css_property_name, scope="support.type.property-name.css"
)
sass_property_value = Attribute(
    "SASS_PROPERTY_VALUE",
    css_property_value,
    scope="support.constant.property-value.css",
)
sass_tag_name = Attribute(
    "SASS_TAG_NAME", css_tag_name, scope="meta.selector.css entity.name.tag"
)
sass_function = Attribute(
    "SASS_FUNCTION", css_function, scope="support.constant.property-value.css"
)
sass_url = Attribute("SASS_URL", css_url, scope="support.constant.property-value.css")
sass_mixin = Attribute(
    "SASS_MIXIN", default_keyword, scope="entity.other.attribute-name.tag"
)
sass_comment = Attribute(
    "SASS_COMMENT", default_block_comment, scope="comment.block.css"
)
...
js_parameter = Attribute(
    "JS.PARAMETER", default_parameter, effect_type=1, scope="variable.parameter"
)
js_instance_member_func = Attribute(
    "JS.INSTANCE_MEMBER_FUNCTION", default_instance_method
)

# YAML
yaml_comment = Attribute(
    "YAML_COMMENT", default_line_comment, scope="comment.line.number-sign.yaml"
)
yaml_scalar_key = Attribute(
    "YAML_SCALAR_KEY", default_keyword, scope="entity.name.tag.yaml"
)
yaml_scalar_value = Attribute(
    "YAML_SCALAR_VALUE", text, scope="string.unquoted.block.yaml"
)
yaml_scalar_string = Attribute(
    "YAML_SCALAR_STRING", text, scope="string.quoted.single.yaml"
)
yaml_scalar_dstring = Attribute(
    "YAML_SCALAR_DSTRING", text, scope="string.quoted.double.yaml"
)
yaml_scalar_list = Attribute(
    "YAML_SCALAR_LIST", text, scope="string.unquoted.block.yaml"
)
yaml_text = Attribute("YAML_TEXT", text, scope="string.unquoted.yaml")
yaml_sign = Attribute("YAML_SIGN", default_operation_sign)

# Puppet
puppet_comment = Attribute(
    "PUPPET_BLOCK_COMMENT", default_line_comment, scope="comment.block.puppet"
)
puppet_regex = Attribute("PUPPET_REGEX", default_string, scope="string.regexp")
puppet_variable = Attribute(
    "PUPPET_VARIABLE",
    default_local_variable,
    scope="punctuation.definition.variable.puppet",
)
puppet_variable_interpolation = Attribute(
    "PUPPET_VARIABLE_INTERPOLATION", default_string, scope="string source"
)
puppet_escape_sequence = Attribute(
    "PUPPET_ESCAPE_SEQUENCE", default_valid_string_escape
)
puppet_resource_reference = Attribute("PUPPET_RESOURCE_REFERENCE", text)
puppet_keyword = Attribute(
    "PUPPET_KEYWORD", default_keyword, scope="keyword.control.puppet"
)
puppet_digit = Attribute("PUPPET_NUMBER", default_number)
puppet_dq_string = Attribute(
    "PUPPET_STRING", default_string, scope="string.quoted.double.puppet"
)
puppet_sq_string = Attribute(
    "PUPPET_SQ_STRING", default_string, scope="string.quoted.single.puppet"
)
puppet_operation_sign = Attribute(
    "PUPPET_OPERATION_SIGN",
    default_operation_sign,
    scope="keyword.operator.assignment.puppet",
)
puppet_parenths = Attribute(
    "PUPPET_PARENTH", default_parentheses, scope="punctuation.section.scope.puppet"
)
puppet_brackets = Attribute(
    "PUPPET_BRACKETS",
    default_brackets,
    scope="punctuation.definition.array.begin.puppet",
)
puppet_braces = Attribute(
    "PUPPET_BRACES", default_braces, scope="punctuation.section.scope.puppet"
)
...
puppet_class = Attribute(
    "PUPPET_CLASS", default_class_name, scope="entity.name.type.class.puppet"
)

# RubyHighlighter
rb_keyword = Attribute("RUBY_KEYWORD", default_keyword)
rb_comment = Attribute("RUBY_COMMENT", default_line_comment)
rb_heredoc_id = Attribute(
    "RUBY_HEREDOC_ID", default_string, scope="punctuation.definition.string.begin.ruby"
)
rb_heredoc = Attribute(
    "RUBY_HEREDOC_CONTENT", default_string, scope="string.unquoted.heredoc.ruby"
)
...
rb_interpolated_string = Attribute(
    "RUBY_INTERPOLATED_STRING", default_string, scope="string.quoted.double.ruby"
)
rb_words = Attribute(
    "RUBY_WORDS", default_string, scope="string.quoted.other.literal.upper.ruby"
)
rb_escape_sequence = Attribute("RUBY_ESCAPE_SEQUENCE", default_valid_string_escape)
rb_invalid_escape_sequence = Attribute(
...
rb_expr_in_string = Attribute(
    "RUBY_EXPR_IN_STRING", default_string, scope="string source"
)
...
rb_method_name = Attribute(
    "RUBY_METHOD_NAME", rb_identifier, scope="entity.name.function"
)
rb_constant = Attribute("RUBY_CONSTANT", rb_identifier, scope="constant")
rb_constant_decl = Attribute(
    "RUBY_CONSTANT_DECLARATION", rb_identifier, scope="entity.name.type.class.ruby"
)
...
rb_ivar = Attribute(
    "RUBY_IVAR", rb_identifier, scope="variable.other.readwrite.instance"
)
...
rb_semicolon = Attribute(
    "RUBY_SEMICOLON", default_semicolon, scope="punctuation.separator.statement"
)
rb_hash_assoc = Attribute(
    "RUBY_HASH_ASSOC", default_operation_sign, scope="punctuation.separator.key-value"
)
...
haml_tag_attribute_name = Attribute(
    "TAG_ATTR_KEY", haml_text, scope="entity.other.attribute-name.html"
)
haml_comment = Attribute(
    "HAML_COMMENT", default_line_comment, scope="comment.line.slash.haml"
)
haml_xhtml = Attribute("HAML_XHTML", haml_text, scope="meta.prolog.haml")
haml_code_injection = Attribute(
    "HAML_RUBY_CODE",
    haml_text,
    scope="source.ruby.embedded.haml",
    foreground=IGNORE_COLOR,
)
haml_ruby_evaluator = Attribute(
    "HAML_RUBY_START", haml_text, scope="meta.line.ruby.haml"
)
...
haml_string = Attribute(
    "HAML_STRING", default_string, scope="string.quoted.single.haml"
)
haml_string_interpolated = Attribute(
    "HAML_STRING_INTERPOLATED", default_string, scope="string.quoted.double.haml"
)
...
slim_tag_start = Attribute(
    "SLIM_TAG_START", slim_text, scope="punctuation.definition.tag.slim"
)
slim_tag_attribute_name = Attribute(
    "SLIM_TAG_ATTR_KEY", haml_text, scope="entity.other.attribute-name.html"
)
slim_comment = Attribute(
    "SLIM_COMMENT", default_line_comment, scope="comment.line.slash.slim"
)
slim_doctype = Attribute("SLIM_DOCTYPE_KWD", slim_tag, scope="meta.prolog.slim")
slim_code_injection = Attribute(
    "SLIM_RUBY_CODE",
    haml_text,
    scope="source.ruby.embedded.slim",
    foreground=IGNORE_COLOR,
)
...
slim_bad_character = Attribute(
    "SLIM_BAD_CHARACTER", slim_text, scope="invalid.illegal.bad-ampersand.html"
)
...
slim_string_interpolated = Attribute(
    "SLIM_STRING_INTERPOLATED", default_string, scope="string.quoted.double.html"
)

# Cucumber (Gherkin)
cucumber_text = Attribute("GHERKIN_TEXT", text, scope="text.gherkin.feature")
cucumber_comment = Attribute(
    "GHERKIN_COMMENT", default_line_comment, scope="comment.line.number-sign"
)
cucumber_keyword = Attribute(
    "GHERKIN_KEYWORD", default_keyword, scope="keyword.language.gherkin.feature"
)
cucumber_tag = Attribute(
    "GHERKIN_TAG", cucumber_text, scope="storage.type.tag.cucumber"
)
cucumber_pystring = Attribute(
    "GHERKIN_PYSTRING", default_string, scope="string.quoted.single"
)
cucumber_table_header = Attribute(
    "GHERKIN_TABLE_HEADER_CELL", cucumber_text, scope="variable.other"
)
cucumber_table_cell = Attribute("GHERKIN_TABLE_CELL", cucumber_text)
cucumber_table_pipe = Attribute(
    "GHERKIN_TABLE_PIPE", default_semicolon, scope="keyword.control.cucumber.table"
)
cucumber_outline_param_substitution = Attribute(
    "GHERKIN_OUTLINE_PARAMETER_SUBSTITUTION", cucumber_text, scope="variable.other"
)
cucumber_scenario_regexp_param = Attribute(
    "GHERKIN_REGEXP_PARAMETER", cucumber_text, scope="string.quoted.double"
)

# CoffeeScript
coffee_block_comment = Attribute(
    "COFFEESCRIPT.BLOCK_COMMENT", default_block_comment, scope="comment.block.coffee"
)
coffee_line_comment = Attribute(
    "COFFEESCRIPT.LINE_COMMENT", default_block_comment, scope="comment.line.coffee"
)
coffee_bad_char = Attribute("COFFEESCRIPT.BAD_CHARACTER", bad_character)
coffee_semicolon = Attribute(
    "COFFEESCRIPT.SEMICOLON",
    default_semicolon,
    scope="punctuation.terminator.statement.coffee",
)
coffee_comma = Attribute(
    "COFFEESCRIPT.COMMA", default_comma, scope="meta.delimiter.object.comma.coffee"
)
coffee_dot = Attribute(
    "COFFEESCRIPT.DOT", default_dot, scope="meta.delimiter.method.period.coffee"
)
coffee_class = Attribute(
    "COFFEESCRIPT.CLASS_NAME", text, scope="entity.name.function.coffee"
)
coffee_identifier = Attribute(
    "COFFEESCRIPT.IDENTIFIER", text, scope="source.coffee", background=IGNORE_COLOR
)
coffee_local_var = Attribute("COFFEESCRIPT.LOCAL_VARIABLE", coffee_identifier)
coffee_global_var = Attribute(
    "COFFEESCRIPT.GLOBAL_VARIABLE",
    coffee_identifier,
    scope="variable.other.readwrite.global",
)
coffee_function_name = Attribute(
    "COFFEESCRIPT.FUNCTION_NAME", text, scope="entity.name.function.coffee"
)
coffee_obj_key = Attribute(
    "COFFEESCRIPT.OBJECT_KEY", text, scope="variable.assignment.coffee"
)
coffee_number = Attribute(
    "COFFEESCRIPT.NUMBER", default_number, scope="constant.numeric.coffee"
)
coffee_bool = Attribute(
    "COFFEESCRIPT.BOOLEAN", default_keyword, scope="constant.language.boolean"
)
coffee_str_bound = Attribute(
    "COFFEESCRIPT.STRING_LITERAL",
    default_string,
    scope="punctuation.definition.string.begin.coffee",
)
coffee_str = Attribute(
    "COFFEESCRIPT.STRING", default_string, scope="string.quoted.single.coffee"
)
coffee_heredoc_id = Attribute(
    "COFFEESCRIPT.HEREDOC_ID",
    default_string,
    scope="punctuation.definition.string.begin.coffee",
)
coffee_heredoc_content = Attribute(
    "COFFEESCRIPT.HEREDOC_CONTENT",
    default_string,
    scope="string.quoted.double.heredoc.coffee",
)
coffee_heregex_id = Attribute(
    "COFFEESCRIPT.HEREGEX_ID", default_string, scope="string.regexp.coffee"
)
coffee_heregex_content = Attribute(
    "COFFEESCRIPT.HEREGEX_CONTENT", default_string, scope="string.regexp.coffee"
)
coffee_js_id = Attribute(
    "COFFEESCRIPT.JAVASCRIPT_ID",
    default_string,
    scope="punctuation.definition.string.begin.coffee",
)
coffee_expression_substitution = Attribute(
    "COFFEESCRIPT.EXPRESSIONS_SUBSTITUTION_MARK",
    text,
    scope="punctuation.section.embedded.coffee",
)
coffee_parenths = Attribute(
    "COFFEESCRIPT.PARENTHESIS", default_parentheses, scope="meta.brace.round.coffee"
)
coffee_brackets = Attribute(
    "COFFEESCRIPT.BRACKET", default_brackets, scope="meta.brace.square.coffee"
)
coffee_braces = Attribute(
    "COFFEESCRIPT.BRACE", default_braces, scope="meta.brace.curly.coffee"
)
coffee_operator = Attribute(
    "COFFEESCRIPT.OPERATIONS", text, scope="keyword.operator.coffee"
)
coffee_operator_exists = Attribute(
    "COFFEESCRIPT.EXISTENTIAL", text, scope="keyword.operator.coffee"
)
coffee_keyword = Attribute(
    "COFFEESCRIPT.KEYWORD", default_keyword, scope="keyword.control.coffee"
)
coffee_range = Attribute(
    "COFFEESCRIPT.RANGE", default_dot, scope="meta.delimiter.method.period.coffee"
)
coffee_splat = Attribute(
    "COFFEESCRIPT.SPLAT", default_dot, scope="meta.delimiter.method.period.coffee"
)
coffee_this = Attribute(
    "COFFEESCRIPT.THIS", default_keyword, scope="variable.language.coffee"
)
coffee_colon = Attribute(
    "COFFEESCRIPT.COLON", default_semicolon, scope="keyword.operator.coffee"
)
coffee_prototype = Attribute(
    "COFFEESCRIPT.PROTOTYPE", text, scope="entity.name.function.coffee"
)
coffee_fun_arrow = Attribute(
    "COFFEESCRIPT.FUNCTION", default_number, scope="storage.type.function.coffee"
)
coffee_fun_binding_arrow = Attribute(
    "COFFEESCRIPT.FUNCTION_BINDING",
    default_number,
    scope="storage.type.function.coffee",
)
coffee_regexp_id = Attribute(
    "COFFEESCRIPT.REGULAR_EXPRESSION_ID", default_string, scope="string.regexp.coffee"
)
coffee_regexp = Attribute(
    "COFFEESCRIPT.REGULAR_EXPRESSION_CONTENT",
    default_string,
    scope="string.regexp.coffee",
)
coffee_regexp_flag = Attribute(
    "COFFEESCRIPT.REGULAR_EXPRESSION_FLAG", default_string, scope="string.regexp.coffee"
)
coffee_escaped_chars = Attribute(
    "COFFEESCRIPT.ESCAPE_SEQUENCE",
    default_valid_string_escape,
    scope="constant.character.escape.coffe",
)
coffee_js_injection = Attribute(
...
# ERB : "text.html.ruby"
erb_text = xml_tag
erb_block_start = Attribute(
    "RHTML_SCRIPTLET_START_ID", erb_text, scope="punctuation.section.embedded.ruby"
)
erb_block_end = Attribute(
    "RHTML_SCRIPTLET_END_ID", erb_text, scope="punctuation.section.embedded.ruby"
)
erb_block_expression_start = Attribute(
    "RHTML_EXPRESSION_START_ID", erb_text, scope="punctuation.section.embedded.ruby"
)
erb_block_expression_end = Attribute(
    "RHTML_EXPRESSION_END_ID", erb_text, scope="punctuation.section.embedded.ruby"
)
erb_comment = Attribute(
    "RHTML_COMMENT_ID", default_line_comment, scope="comment.block.erb"
)
erb_omit_line_modifier = Attribute(
    "RHTML_OMIT_NEW_LINE_ID", erb_text, scope="punctuation.section.embedded.ruby"
)
erb_ruby_injection_bg = Attribute(
    "RHTML_SCRIPTING_BACKGROUND_ID",
    erb_text,
    scope="source.ruby.rails.embedded.html",
    foreground=IGNORE_COLOR,
)
...
oc_conditionally_not_compiled = Attribute(
    "CONDITIONALLY_NOT_COMPILED", default_block_comment
)
...
oc_local_variable = Attribute(
    "OC.LOCAL_VARIABLE", text, scope="variable.other.selector.objc"
)
...
oc_selfsuperthis = Attribute(
    "OC.SELFSUPERTHIS", oc_keyword, scope="variable.language.objc"
)
...
oc_protocol_reference = Attribute(
    "PROTOCOL_REFERENCE", oc_class_reference, scope="meta.implementation.objc"
)
oc_message_argument = Attribute(
    "OC.MESSAGE_ARGUMENT", default_function_call, scope="entity.name.function"
)
oc_method_declaration = Attribute(
    "OC.METHOD_DECLARATION", default_function_declaration, scope="entity.name.function"
)
...
go_package_exported_constant = Attribute(
    "GO_PACKAGE_EXPORTED_CONSTANT", default_constant
)
...
go_exported_function_call = Attribute(
...
custom_multi_line_comment = Attribute(
    "CUSTOM_MULTI_LINE_COMMENT_ATTRIBUTES", default_doc_comment
)
custom_valid_string_escape = Attribute(
    "CUSTOM_VALID_STRING_ESCAPE_ATTRIBUTES", default_valid_string_escape
)
custom_invalid_string_escape = Attribute(
    "CUSTOM_INVALID_STRING_ESCAPE_ATTRIBUTES", default_invalid_string_escape
)
        ...
        if scope_of_setting is None:
            ...
            for aScope in scopes_of_setting:
                ...
                if scope is not None and scope.startswith(matchingScope):
                    ...
                    weight = (
                        ss_less_specific_weight
                        if isSimpleScope
                        else less_specific_weight
                    )
...
def load_textmate_scheme(tmtheme):
    ...
    if "background" in default_settings:
        ...
        if "invisibles" in default_settings:
            all_colors["INDENT_GUIDE"] = color_from_textmate(
                default_settings["invisibles"], background
            )
            all_colors["SELECTED_INDENT_GUIDE"] = all_colors["INDENT_GUIDE"]
            all_colors["WHITESPACES"] = color_from_textmate(
                default_settings["invisibles"], background
            )

        if "selection" in default_settings:
            selection_background = color_from_textmate(
                default_settings["selection"], background
            )
            all_colors["SELECTION_BACKGROUND"] = selection_background

        if "lineHighlight" in default_settings:
            caret_row_color = color_from_textmate(
                default_settings["lineHighlight"], background
            )
    ...
    if "foreground" in default_settings:
        all_colors["LINE_NUMBERS_COLOR"] = color_from_textmate(
            default_settings["foreground"]
        )

    if (
        caret_row_color is not None
        and selection_background is not None
        and selection_background == caret_row_color
    ):
    ...
    for attr in all_attributes:
        if attr.scope:
            ...
            if settings:
                ...
                attr.value = attr_from_textmate(
                    settings["settings"], attr.value, background
                )
            else:
...
def write_idea_scheme(filename):
    ...
    for attr in all_attributes:
        ...
        if (
            saveFg
            or saveBg
            or attr.value.font_style
            or attr.value.effect_type
            or attr.value.error_stripe
        ):
            option = ET.SubElement(attributes, "option", name=attr.id)
            value = ET.SubElement(option, "value")
            if saveFg:
                ET.SubElement(value, "option", name="FOREGROUND", value=fore)
            if saveBg:
                ET.SubElement(value, "option", name="BACKGROUND", value=back)
            if attr.value.font_style:
                ET.SubElement(
                    value, "option", name="FONT_TYPE", value=str(attr.value.font_style)
                )
            if attr.value.effect_type:
                ET.SubElement(
                    ...
                    "option",
                    name="EFFECT_TYPE",
                    value=str(attr.value.effect_type),
                )
            ...
            if attr.value.error_stripe:
                ET.SubElement(
                    value,
                    "option",
                    name="ERROR_STRIPE_COLOR",
                    value=attr.value.error_stripe,
                )
        else:
            ET.SubElement(
